...
public class Parser {
    ...
    private static final String FIND_FORMAT = "Find format should be: find-note-with-body <SEARCH_TERMS>";
    ...
    public static Command parse(String input) throws ZettelException {
        ...
        case "find-note-with-body" -> parseFindNoteByBodyCommand(inputs);
    ...
    /**
     * Parses a find-note-with-body command to search for notes by body content.
     * Expected format: find-note-with-body SEARCH_TERMS
     *
     * @param inputs The tokenized user input split by spaces
